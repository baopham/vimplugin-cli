  ...
  _createClass(VimPlug, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                Object.keys(mapper).forEach(function (plugin) {
    ...
    value: function () {
      var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
        var vimrcContent, regex;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                vimrcContent = this.getVimrcContent();
                regex = new RegExp('Plug \'(.+)\'');


                vimrcContent.split(_os.EOL).forEach(function (line) {
    ...
    value: function () {
      var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(pluginToSearch) {
        var _this = this;
      ...
      function findAndRemovePluginSetting(_x3) {
    ...
    value: function () {
      var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(pluginToSearch, vimrcContent) {
        var _this2 = this;
      ...
      function findAndRemovePlugs(_x4, _x5) {
    ...
    value: function buildPluginAndLineIndexMapper(pluginToSearch, vimrcContent) {
      var regex = new RegExp('Plug \'(\\S*' + pluginToSearch + '\\S*)\'', 'i');

      var lines = vimrcContent.split(_os.EOL);

      var mapper = lines.reduce(function (acc, line, lineIndex) {
        var _ref6 = regex.exec(line) || [],
